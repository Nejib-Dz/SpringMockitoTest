package net.najib.springboot.repository;
...
//                .build();
        ...
        savedEmployee.setEmail("najib@gmail.com");
        savedEmployee.setFirstName("najib");
